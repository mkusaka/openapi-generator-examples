...
OpenapiClient - the Ruby gem for the Swagger Petstore - OpenAPI 3.0
...
------------ | ------------- | ------------- | -------------
*OpenapiClient::PetApi* | [**add_pet**](docs/PetApi.md#add_pet) | **POST** /api/d/pet | Add a new pet to the store
...
*OpenapiClient::PetApi* | [**update_pet**](docs/PetApi.md#update_pet) | **PUT** /api/d/pet | Update an existing pet
...
*OpenapiClient::UserApi* | [**update_user**](docs/UserApi.md#update_user) | **PUT** /user/{username} | Update user
